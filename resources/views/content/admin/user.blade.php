        ...
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex flex-column flex-sm-row align-items-center justify-content-between">
                    <button type="button" class="btn btn-primary mb-3 mb-sm-0" data-bs-toggle="modal" data-bs-target="#addUserModal" @cannot('users.edit') disabled @endcannot>Adicionar Membro</button>
