    ...
    <div class="col-lg-8 mb-4 order-0">
      <div class="card">
        <div class="d-flex align-items-end row">
          <div class="col-sm-7">
            <div class="card-body">
              <h5 class="card-title text-primary">Bem vindo, {{ explode(' ', auth()->user()->name)[0] }}! 🎉</h5>
              <p class="mb-4">Comece a navegar clicando no <span class="fw-bold">menu</span> à esquerda.<br>Seu último
                login foi em <span
        ...
        <div class="col-lg-6 col-md-12 col-6 mb-4">
          <div class="card">
            <div class="card-body px-3">
              ...
              <small class="text-success fw-semibold"><i class='bx bx-up-arrow-alt'></i> + R$ 1,540.53</small>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-md-12 col-6 mb-4">
          <div class="card">
            <div class="card-body px-3">
              ...
              <small class="text-success fw-semibold"><i class='bx bx-up-arrow-alt'></i> + R$ 1,320.05</small>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card mb-3" style="height: calc(100% - 24px);">
        ...
        <div class="card-body">
          <ul class="p-0 m-0">
            ...
            <li class="d-flex mb-4 pb-1">
              <div class="avatar flex-shrink-0 me-3">
                <img src="{{asset('assets/img/icons/unicons/wallet-info.png')}}" alt="User" class="rounded">
              </div>
              <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                <div class="me-2">
  ...
  @can('users.read')
    ...
    <div class="col-12">
      <div class="card pb-5" id="membersTableCard">
        <div class="card-header"><h5 class="mb-0">Membros e Pastores da IPP</h5></div>
              ...
              <tr>
                <td class="d-flex justify-content-center">
                  <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                      class="avatar avatar-xs pull-up" title="" data-bs-original-title="Foto de {{ explode(' ', $user->name)[0] }}"><img
                      src="{{asset('storage/' . $user->profile_picture )}}" alt="Avatar" class="rounded-circle"></li>
                </td>
    ...
    var chartConfig = {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderColor: "rgb(105, 108, 255, 0.9)",
          fill: true,
          data: [50, 140, 90, 120, 200, 200, 140],
        }, {
          label: 'Ofertas',
          backgroundColor: "rgba(3, 195, 236, 0.4)",
          borderColor: "rgb(3, 195, 236, 0.9)",
          fill: true,
