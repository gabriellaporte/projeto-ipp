              ...
              <li>
                <a class="dropdown-item" href="{{ route('account.notifications.index') }}">
                  <span class="d-flex align-items-center align-middle">
                      ...
                      @if(count(auth()->user()->notifications->whereNull('read')))
                        <span class="flex-shrink-0 badge badge-center rounded-pill bg-danger w-px-20 h-px-20">{{ count(auth()->user()->notifications->whereNull('read')) }}</span>
                      @endif
                  </span>
                </a>
              </li>
